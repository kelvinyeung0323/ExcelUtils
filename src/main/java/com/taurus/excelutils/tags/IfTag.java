...
package com.taurus.excelutils.tags;


import com.taurus.excelutils.ExcelParser;
import com.taurus.excelutils.WorkbookUtils;
...
//			bResult = false;
//		}
      //TODO:把scriptEngine 放进threadLocal
      ScriptEngineManager manager = new ScriptEngineManager();
      ScriptEngine scriptEngine = manager.getEngineByName("javascript");
      try {
          Object v = scriptEngine.eval(expr);
          bResult = ((Boolean)v).booleanValue();
