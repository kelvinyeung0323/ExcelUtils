...
import com.taurus.excelutils.tags.ITag;
...
public class ExcelParser {
  ...
  public static void parseCell(Object context, Sheet sheet, Row row, Cell cell) {
    ...
    if (row.getRowNum() - 1 >= sheet.getFirstRowNum() && bMerge) {
      ...
      if (canMerge) {
        sheet
            .addMergedRegion(new CellRangeAddress(lastRow.getRowNum(), lastCell.getColumnIndex(), row.getRowNum(), cell.getColumnIndex()));
      }
    }
